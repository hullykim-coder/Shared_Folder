...
> 📷 **사진 표기 안내**: 본문 중 `📷 [사진: 설명]` 표시는 해당 위치에 스크린샷/사진을 넣으면 좋은 자리입니다.
>
> 📷 **[사진: 최종 완성 결과 — 전원 ON→UEFI 회사로고→Plymouth 회사로고→로그인 후 회사로고→데스크탑 GUI앱, 4단계를 시간순으로 배열]**
...
📷 **[사진: Jetson 보드의 REC/RESET/PWR 버튼 위치]**
...
📷 **[사진: SDK Manager STEP 01 화면 — Target Hardware / JetPack 7.2 선택 상태]**
...
📷 **[사진: balenaEtcher로 USB 굽는 화면]**
📷 **[사진: Jetson 모니터의 GRUB 설치 메뉴 "Install Jetson ISO 39.2.0"]**
📷 **[사진: SDK Manager STEP 04 "INSTALLATION COMPLETED SUCCESSFULLY" 화면]**
...
📷 **[사진: 교체 전 — 전원 ON 직후 NVIDIA 로고 + "ESC to enter Setup" 화면]**
...
📷 **[사진: 교체 후 — 전원 ON 직후 회사 로고로 바뀐 UEFI 화면]**
...
📷 **[사진: Plymouth 단계에서 회사 로고가 표시된 부팅 화면]**
...
📷 **[사진: 로그인 후 회사 로고로 바뀐 전환 화면 (검은 배경)]**
📷 **[사진: 최종 데스크탑 — 회사 배경 + GUI 앱(HVAC 패널) 자동 실행 상태]**
