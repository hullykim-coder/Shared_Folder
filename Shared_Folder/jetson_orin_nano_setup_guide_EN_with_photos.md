...
*Fig. Final result — company logo at all 4 stages (UEFI / Plymouth / Login / Desktop)*
...
*Fig. Jetson board (underside — microSD slot / buttons / connectors)*
...
*Fig. SDK Manager STEP 01 — JetPack 7.2 / Target Hardware selected*
...
*Fig. Burning the install USB with balenaEtcher*
📷 **[Photo: GRUB install menu "Install Jetson ISO 39.2.0" on the Jetson monitor]**
![](guide_images/sdk_step04.png)

*Fig. SDK Manager STEP 04 — INSTALLATION COMPLETED SUCCESSFULLY*
...
*Fig. (Before) UEFI stage — NVIDIA logo + firmware version*
...
*Fig. (After) UEFI stage — company logo*
...
*Fig. Plymouth boot splash — company logo*
...
*Fig. Post-login transition — company logo*
![](guide_images/desktop.jpg)

*Fig. Final desktop — GUI app (HVAC panel) auto-launched*
